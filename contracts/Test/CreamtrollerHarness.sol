...
import "../../contracts/Creamtroller/Creamtroller.sol";
import "../../contracts/Interfaces/PriceOracle.sol";

contract CreamtrollerHarness is Creamtroller {
    address compAddress;
...
contract BoolCreamtroller is CreamtrollerInterface {
    bool allowMint = true;
...
contract EchoTypesCreamtroller is UnitrollerAdminStorage {
