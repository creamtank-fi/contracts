...
*/
contract CreamtrollerRewards is CreamtrollerV1Storage, CreamtrollerInterface, CreamtrollerErrorReporter, Exponential {
    ...
    */
    ...
    function _setRewardDistributor(address newRewardDistributor) public returns (uint256) {
        if (msg.sender != admin) {
    ...
    */
    ...
    function claimReward(address holder) public {
        RewardDistributor(rewardDistributor).claimReward(holder);
    }
    ...
    */
    function claimReward(
        ...
        RewardDistributor(rewardDistributor).claimReward(holder, cTokens);
    }
    ...
    */
    function claimReward(
        ...
        RewardDistributor(rewardDistributor).claimReward(holders, cTokens, borrowers, suppliers);
    }
}
